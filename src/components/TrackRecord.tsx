...
export default function TrackRecord() {
  return (
    <section className="bg-[#0E1117] w-full py-24">
      ...
      <div className="mx-6 md:mx-8 bg-[#161B24] rounded-3xl overflow-visible">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
          {/* Left Column — desktop: overlapping collage */}
          <div className="hidden lg:block relative" style={{height: '620px'}}>

            {/* Big background box */}
            <div className="absolute bg-[#161B24] border border-[#60a5fa]/20 rounded-2xl"
          ...
          {/* Left Column — mobile: stacked images */}
          <div className="lg:hidden flex flex-col gap-4 p-6">
            <Image src="/images/discord-callout.png" alt="Alert 1" width={400} height={340}
              className="w-full rounded-xl border border-white/15 shadow-[0_16px_40px_rgba(0,0,0,0.7)]" />
            <Image src="/images/callout2.png" alt="Alert 2" width={400} height={340}
              className="w-full rounded-xl border border-white/15 shadow-[0_16px_40px_rgba(0,0,0,0.7)]" />
          </div>
