    ...
    <div className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center justify-between gap-4 px-5 h-12 rounded-full bg-white/90 backdrop-blur-xl border border-gray-200 shadow-[0_8px_32px_rgba(0,0,0,0.08)] w-full max-w-3xl">
        ...
        <div className="hidden md:flex items-center gap-5 text-sm">
          ...
          <a href="/results" className="text-gray-500 hover:text-black transition-colors">Results</a>
          <a href="/#pricing" className="text-gray-500 hover:text-black transition-colors">Pricing</a>
          <a href="/community" className="text-gray-500 hover:text-black transition-colors">Community</a>
          <a href="/blog" className="text-gray-500 hover:text-black transition-colors">Blog</a>
          <a href="/free-scanner" className="text-gray-500 hover:text-black transition-colors font-semibold">Free Scanner</a>
          ...
          <a href="/login" className="text-gray-500 hover:text-black transition-colors">Login</a>
        </div>
        <div className="flex items-center gap-3 flex-shrink-0">
          <a href="/login" className="md:hidden text-gray-500 hover:text-black text-sm transition-colors">Login</a>
          <a
