...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: "/newsletter/opengraph-image", width: 1200, height: 630, alt: "The Flow Brief — Daily Options Flow Newsletter" }],
  },
  twitter: {
      ...
      <main className="bg-white">
        ...
        <section className="max-w-3xl mx-auto px-6 py-12 border-t border-gray-100">
          ...
          <div className="flex flex-wrap gap-4 text-[14px]">
            ...
            <span className="text-gray-300">·</span>
            <Link href="/methodology" className="text-[#F97316] hover:underline">Data Methodology</Link>
            <span className="text-gray-300">·</span>
            <Link href="/blog/how-to-read-options-flow" className="text-[#F97316] hover:underline">How to Read Options Flow</Link>
            <span className="text-gray-300">·</span>
            <Link href="/pricing" className="text-[#F97316] hover:underline">Start Trial</Link>
          </div>
        </section>
      </main>
