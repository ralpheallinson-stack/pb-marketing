      ...
      <main className="bg-white">
        ...
        <section className="max-w-5xl mx-auto px-6 pt-8 pb-12">
          ...
          <p className="text-[18px] text-gray-600 leading-relaxed max-w-3xl mb-10">
            <strong className="text-gray-900">{ga.total.toLocaleString()}</strong> Grade A institutional flow signals on {t.symbol}, captured via the live OPRA tape with CBOE Rule 6.11 sweep detection and Black-Scholes-Merton Greeks. Methodology at <Link href="/methodology" className="underline hover:text-[#F97316]">/methodology</Link>.
          </p>
        ...
        <section className="max-w-5xl mx-auto px-6 py-10 border-t border-gray-100 text-[12px] text-gray-400 leading-relaxed">
          <strong className="text-gray-500">Methodology.</strong> Grade A signals pass the institutional-flow filter pipeline: institutional premium floor, contract-level volume baseline, aggressive fill detection, market-maker filtering, opening-position classification. See /methodology for the full data methodology. Exit rules are DTE-based: 0DTE +20%/-20%, 1-5 DTE +25%/-25%, 6-30 DTE +40%/-30%, 30+ DTE +30%/-30%. See the full <Link href="/methodology" className="text-[#F97316] hover:underline">data methodology →</Link>.
        </section>
      </main>
