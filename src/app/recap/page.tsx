...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: CANON,
    type: "website",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Profit Builders Daily Flow Recaps" }],
  },
  twitter: {
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-8 max-md:px-6">
          ...
          <section className="pt-20 pb-16 border-b pb-hairline">
            ...
            <p className="pb-editorial text-[17px] leading-[1.65] text-white/65 max-w-[660px]">
              Each recap is written the night of the session, against the day&apos;s scanner output. We don&apos;t cherry-pick winners — we publish the same recap whether the tape was clean or whether the scanner misfired on two of three reads. The recaps are free; the engine that produces them is at <Link href="/methodology" className="text-[#60a5fa] border-b border-[#60a5fa]/40">profitbuilders.io/methodology</Link>.
            </p>
