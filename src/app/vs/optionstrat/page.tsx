        ...
        <section className="px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto py-8 grid grid-cols-3 gap-6 max-md:grid-cols-1 max-md:gap-3">
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              ...
              <div className="pb-editorial text-[28px] text-white font-normal tracking-[-0.01em] max-md:text-[20px]">$49.99/mo</div>
            </div>
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t pb-hairline">
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                ...
                <span className="pb-editorial text-[14px] text-white/55 text-right">$49.99/mo</span>
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="py-7 border-b pb-hairline">
              ...
              <p className="pb-editorial text-[16px] leading-[1.6] text-white/65 max-w-[760px]">Yes — Live Flow tier is $49.99/mo vs Profit Builders' $99. They solve different problems. OptionStrat helps you build a trade; Profit Builders helps you find one.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
            ...
            <div className="py-7 border-b pb-hairline">
              ...
              <p className="pb-editorial text-[16px] leading-[1.6] text-white/65 max-w-[760px]">Yes, but it's 15-minute delayed and shows roughly 10% of the full flow feed. For real-time flow, you need Live Flow at $49.99/mo.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
