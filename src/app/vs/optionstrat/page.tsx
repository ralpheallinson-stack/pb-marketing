...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'OptionStrat vs Profit Builders · Builder or Signal',
    description: "OptionStrat helps you draw the trade. Profit Builders helps you find it. Two different jobs at about the same price. Here's which one your workflow needs.",
    url: CANON,
    type: "article",
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type": "Question", "name": "Is OptionStrat cheaper than Profit Builders?", "acceptedAnswer": {"@type": "Answer", "text": "Not really — OptionStrat's Live Flow tier is $99.99/mo, about the same as Profit Builders' $99. They solve different problems: OptionStrat helps you build a trade; Profit Builders helps you find one. OptionStrat's cheaper Live Tools tier ($39.99/mo) drops real-time flow."}},
    ...
    {"@type": "Question", "name": "Does OptionStrat have a free tier?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, but it's 15-minute delayed and shows roughly 10% of the full flow feed. For real-time flow, you need Live Flow at $99.99/mo."}},
        ...
        <section className="pt-32 pb-16 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="pb-editorial text-[40px] sm:text-[56px] md:text-[68px] leading-[1.04] tracking-[-0.025em] text-white mb-6 mt-2">
              <em className="italic text-white/70">OptionStrat</em> vs Profit Builders.
            </h1>
        ...
        <section className="px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto py-8 grid grid-cols-3 gap-6 max-md:grid-cols-1 max-md:gap-3">
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              <div className="pb-mono text-[10px] tracking-[0.22em] text-white/40 uppercase mb-2 max-md:mb-0">OptionStrat Live Flow</div>
              <div className="pb-editorial text-[28px] text-white font-normal tracking-[-0.01em] max-md:text-[20px]">$99.99/mo</div>
            </div>
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
            ...
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              ...
              <div className="pb-editorial text-[28px] text-white font-normal tracking-[-0.01em] max-md:text-[20px]">Build trade vs find trade</div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t pb-hairline">
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-white/70">Price (live flow tier)</span>
                <span className="pb-editorial text-[14px] text-white/55 text-right">$99.99/mo</span>
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                ...
                <span className="pb-editorial text-[14px] text-white/55 text-right">7-day on paid plans</span>
                <span className="pb-editorial text-[14px] text-white text-right">7-day full-access</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-white/70">Strategy builder + payoff visualizer</span>
                <span className="pb-editorial text-[14px] text-white/55 text-right">Yes (best in class)</span>
                <span className="pb-editorial text-[14px] text-white text-right">—</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-white/70">Live options flow</span>
                <span className="pb-editorial text-[14px] text-white/55 text-right">Yes (Live Flow tier)</span>
                <span className="pb-editorial text-[14px] text-white text-right">Yes (real-time)</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-12 max-md:grid-cols-1 max-md:gap-8">
              <div>
                <div className="pb-mono text-[11px] tracking-[0.22em] text-white/40 uppercase mb-4">Pick OptionStrat if</div>
                <p className="pb-editorial text-[17px] leading-[1.6] text-white/70">You already have a thesis and want to model it. Spreads, butterflies, calendars — you draw payoff curves and pick the structure. The flow tab is supplemental.</p>
              </div>
              <div>
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-white mb-3 leading-[1.3]">Is OptionStrat cheaper than Profit Builders?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-white/65 max-w-[760px]">Not really — OptionStrat's Live Flow tier is $99.99/mo, about the same as Profit Builders' $99. They solve different problems: OptionStrat helps you build a trade; Profit Builders helps you find one. OptionStrat's cheaper Live Tools tier ($39.99/mo) drops real-time flow.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
            ...
            <div className="py-7 border-b pb-hairline">
              ...
              <p className="pb-editorial text-[16px] leading-[1.6] text-white/65 max-w-[760px]">Yes — that's the most common stack. Profit Builders surfaces the institutional print, you take the underlying conviction to OptionStrat to model the spread or structure that fits your view.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-white mb-3 leading-[1.3]">Does OptionStrat have a free tier?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-white/65 max-w-[760px]">Yes, but it's 15-minute delayed and shows roughly 10% of the full flow feed. For real-time flow, you need Live Flow at $99.99/mo.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
