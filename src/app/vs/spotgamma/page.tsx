        ...
        <section className="pt-32 pb-16 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="pb-editorial text-[40px] sm:text-[56px] md:text-[68px] leading-[1.04] tracking-[-0.025em] text-gray-950 mb-6 mt-2">
              <em className="italic text-gray-700">SpotGamma</em> vs Profit Builders.
            </h1>
        ...
        <section className="px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto py-8 grid grid-cols-3 gap-6 max-md:grid-cols-1 max-md:gap-3">
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              <div className="pb-mono text-[10px] tracking-[0.22em] text-gray-400 uppercase mb-2 max-md:mb-0">SpotGamma Alpha</div>
              <div className="pb-editorial text-[28px] text-gray-950 font-normal tracking-[-0.01em] max-md:text-[20px]">$299/mo</div>
            </div>
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              <div className="pb-mono text-[10px] tracking-[0.22em] text-gray-400 uppercase mb-2 max-md:mb-0">Profit Builders Pro</div>
              <div className="pb-editorial text-[28px] text-gray-950 font-normal tracking-[-0.01em] max-md:text-[20px]">$129/mo</div>
            </div>
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              <div className="pb-mono text-[10px] tracking-[0.22em] text-gray-400 uppercase mb-2 max-md:mb-0">Saving</div>
              <div className="pb-editorial text-[28px] text-gray-950 font-normal tracking-[-0.01em] max-md:text-[20px]">$2,040/year</div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t pb-hairline">
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Top tier price</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">$299/mo (Alpha)</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">$129/mo (Pro Bundle)</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Entry tier price</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">$99/mo (Essential)</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">$39/mo (GEX standalone)</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Dealer gamma / GEX modeling</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">Yes (HIRO, Equity Hub)</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">Yes (220 symbols)</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Whale prints / live flow</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">—</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">Real-time flow + grading</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-12 max-md:grid-cols-1 max-md:gap-8">
              <div>
                <div className="pb-mono text-[11px] tracking-[0.22em] text-gray-400 uppercase mb-4">Pick SpotGamma if</div>
                <p className="pb-editorial text-[17px] leading-[1.6] text-gray-700">You're macro-positioning around dealer flow. You care about gamma walls, vol regime, charm/vanna effects, and you want HIRO's intraday models. SpotGamma is the deepest dedicated GEX product.</p>
              </div>
              <div>
                <div className="pb-mono text-[11px] tracking-[0.22em] text-[#F97316] uppercase mb-4">Pick Profit Builders if</div>
                <p className="pb-editorial text-[17px] leading-[1.6] text-gray-700">You want both gamma context AND the actual whale prints — graded — for half the price of SpotGamma Alpha. Or you only need GEX, in which case Profit Builders' $39 standalone undercuts SpotGamma Essential by 60%.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">How does SpotGamma differ from Profit Builders?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">SpotGamma grades dealer positioning — where market makers will hedge, where gamma walls form. Profit Builders grades whale prints — the actual large bets institutions place. Different reads on the same tape.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Is SpotGamma worth $299?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">If your edge is macro-gamma positioning, yes. SpotGamma Alpha includes HIRO, Equity Hub, and the deepest dealer-flow models in the category. If you also want live whale prints, you'd add another tool.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Does SpotGamma offer a free trial?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">No free trial on either Essential or Alpha. Profit Builders offers 7 days free on every tier.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Can I get just GEX from Profit Builders?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">Yes — Profit Builders' GEX Heatmap is a $39/mo standalone. That's 60% cheaper than SpotGamma Essential ($99) and covers 220 symbols.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Do they overlap?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">On the GEX/dealer-gamma side, yes. On whale-print scanning, only Profit Builders. The Pro Bundle ($129) covers both at less than half of SpotGamma Alpha.</p>
            </div>
          </div>
        </section>
