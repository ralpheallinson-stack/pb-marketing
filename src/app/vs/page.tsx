...
const COMPETITORS = [
  {
    ...
    tldr: "Bigger brand and Congressional trade data. We add grading, a public documented OPRA methodology, and Telegram alerts.",
    wins: "Congress data · Raw flow · Cheapest tier",
    losses: "No grading · No documented methodology",
  },
  {
    slug: "flowalgo",
    name: "FlowAlgo",
    ...
    tldr: "$149/mo with a $37 trial that auto-charges. We're $99/mo with a genuine 7-day free trial and a documented methodology.",
  ...
  },
  {
    ...
    losses: "Feature gating · No documented methodology",
  },
  {
    slug: "barchart",
    name: "Barchart",
  ...
  },
  {
    ...
    tldr: "Effectively the same monthly price. They're a live trading-room community. We're a graded-signal engine with documented OPRA methodology.",
    wins: "Live trading rooms · iOS + Android app · Voice",
    losses: "No documented methodology · Color codes vs documented filters",
  },
  {
