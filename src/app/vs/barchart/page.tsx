        ...
        <section className="pt-32 pb-16 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <h1 className="pb-editorial text-[40px] sm:text-[56px] md:text-[68px] leading-[1.04] tracking-[-0.025em] text-gray-950 mb-6 mt-2">
              <em className="italic text-gray-700">Barchart</em> vs Profit Builders.
            </h1>
        ...
        <section className="px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto py-8 grid grid-cols-3 gap-6 max-md:grid-cols-1 max-md:gap-3">
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              <div className="pb-mono text-[10px] tracking-[0.22em] text-gray-400 uppercase mb-2 max-md:mb-0">Barchart Pro</div>
              <div className="pb-editorial text-[28px] text-gray-950 font-normal tracking-[-0.01em] max-md:text-[20px]">$199.95/mo</div>
            </div>
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
            ...
            <div className="text-center max-md:text-left max-md:flex max-md:items-baseline max-md:justify-between max-md:gap-4 max-md:border-b max-md:pb-hairline max-md:pb-3">
              ...
              <div className="pb-editorial text-[28px] text-gray-950 font-normal tracking-[-0.01em] max-md:text-[20px]">$1,212/year</div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="border-t pb-hairline">
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Price (real flow tier)</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">$199.95/mo</span>
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                ...
                <span className="pb-editorial text-[14px] text-gray-500 text-right">30-day for $7.99</span>
              ...
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Discord + Telegram alerts</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">—</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">Yes (1.4s median)</span>
              </div>
              <div className="grid grid-cols-[1.4fr_1fr_1fr] gap-4 py-4 border-b pb-hairline items-baseline max-md:grid-cols-[1fr_1fr] max-md:[&>*:first-child]:col-span-2 max-md:[&>*:first-child]:mb-2">
                <span className="pb-editorial text-[15px] text-gray-700">Breadth: equities, futures, news</span>
                <span className="pb-editorial text-[14px] text-gray-500 text-right">Yes (broad)</span>
                <span className="pb-editorial text-[14px] text-gray-950 text-right">Options flow only</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-12 max-md:grid-cols-1 max-md:gap-8">
              <div>
                <div className="pb-mono text-[11px] tracking-[0.22em] text-gray-400 uppercase mb-4">Pick Barchart if</div>
                <p className="pb-editorial text-[17px] leading-[1.6] text-gray-700">You want a single subscription that covers quotes, charts, futures, news, and basic options flow. You're a generalist who would otherwise pay for 3 separate tools.</p>
              </div>
              <div>
                <div className="pb-mono text-[11px] tracking-[0.22em] text-[#F97316] uppercase mb-4">Pick Profit Builders if</div>
                <p className="pb-editorial text-[17px] leading-[1.6] text-gray-700">You want institutional options flow specifically — graded by a transparent rubric — and you want to verify outcomes before you trust the signals.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 border-b pb-hairline">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Is Barchart Pro worth $199.95/mo?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">It depends on whether you need broad market coverage. Barchart Pro bundles options flow with futures, equities, charting, and news. If you'd otherwise pay for those separately, the math works. If you only want options flow, you're paying ~$100/mo for features outside your workflow.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Does Barchart publish signal outcomes?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">No. Barchart provides flow data but doesn't grade signals or publish a documented methodology. Profit Builders publishes every Grade A/B signal at /results — currently documented OPRA processing methodology.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Which is cheaper for pure options flow?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">Profit Builders at $99/mo. Barchart's flow features at the Premier tier ($39.95) are basic; you need Pro ($199.95) for serious options analysis.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Does Profit Builders cover futures or stocks like Barchart does?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">No. Profit Builders does options flow specifically. If you need futures + equity coverage, Barchart is the broader platform.</p>
            </div>
            <div className="py-7 border-b pb-hairline">
              <h3 className="pb-editorial text-[20px] md:text-[22px] text-gray-950 mb-3 leading-[1.3]">Can I trial both?</h3>
              <p className="pb-editorial text-[16px] leading-[1.6] text-gray-700 max-w-[760px]">Profit Builders offers a 7-day free trial with full access. Barchart's trial is paid (30 days for $7.99) and converts to monthly billing.</p>
            </div>
          </div>
        </section>
