...
const productSchema = JSON.stringify({
  ...
  "description": "Real-time institutional options flow scanner with conviction grading, Greeks, IV, spread detection, and GEX heatmap. 174,000+ signals tracked publicly at /results.",
