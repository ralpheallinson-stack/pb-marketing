...
export default async function BlogPostPage({
  ...
  const FAQ_DATA: Record<string, {q: string, a: string}[]> = {
    ...
    "spotgamma-vs-profit-builders": [
      { q: "Is SpotGamma or Profit Builders better for options traders?", a: "They solve different problems. SpotGamma grades dealer positioning and gamma exposure across indices (SPX, SPY, QQQ). Profit Builders grades individual whale prints across 220+ single-name tickers with a 9-filter conviction engine. SpotGamma is best for macro gamma regime traders. Profit Builders is best for directional single-stock flow traders." },
    ...
    "market-chameleon-vs-profit-builders": [
      ...
      { q: "Does Market Chameleon have conviction grading like Profit Builders?", a: "No. Market Chameleon shows unusual options activity but does not grade signals by conviction, filter market maker hedges, or publish per-signal outcomes. Profit Builders runs every print through a 9-filter conviction engine and publishes a full track record of 174,000+ signals with P&L at /results." },
    ],
  }
