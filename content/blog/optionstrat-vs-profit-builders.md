...
**Documented data methodology.** Every Grade A and Grade B signal is tracked with full P&L outcomes on [the resolved-trade ledger](/results) — OPRA tape ingest, sweep detection, NBBO aggression, and entry/exit reporting on every signal. OptionStrat doesn't publish signal performance because flow isn't their core product; they don't own the outcomes.
