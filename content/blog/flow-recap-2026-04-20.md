---
title: "NVDA Dominated April 20 — $316M in Institutional Flow"
description: "NVDA led a $3.54B tape on April 20, 2026. 391 Grade A signals, 63% buy-side lean, and one name that wouldn't stop printing."
date: "2026-04-20"
...
That's not one trader making a move. That's a pattern of [repeated entries into the same structure](/blog/what-is-options-accumulation), broken into pieces, executed across hours. The contracts, strikes, and exact timing — those are in the live feed. But the shape of it was unmistakable by midday.
...
Three prints. Three exits. The entries came from the same flow data this recap is summarizing — [Grade A signals](/blog/options-flow-signals-grade-a-b-c) with structure, size, and timing that separated them from the noise. The strikes and expirations that generated those returns were visible to subscribers at the moment they crossed.
